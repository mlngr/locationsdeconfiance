    ...
    <main className="container py-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Link href="/owner/wizard/adresse" className="btn btn-primary">Assistant création</Link>
          <Link href="/properties/new" className="btn btn-outline">Formulaire classique</Link>
        </div>
      </div>
