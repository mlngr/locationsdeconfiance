...
export default function DashboardPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setUserId(user.id);
      const userRole = (user.user_metadata as any)?.role ?? "owner";
      setRole(userRole);
      ...
      // Fetch user's properties (only for owners)
      ...
      <div className="container py-12 space-y-6">
        ...
        {role === "owner" ? (
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-semibold mb-4">Mes annonces ({properties.length})</h2>
                ...
                <>
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {currentProperties.map((property) => (
                      <div key={property.id} className="card hover:shadow-xl transition">
